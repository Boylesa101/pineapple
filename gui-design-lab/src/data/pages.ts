...
const pageDefinitions: LabPage[] = [
  ...
  { id: 16, slug: 'home-dashboard', name: 'Home Dashboard', shortDescription: 'Main app overview showing current trip, alerts, weather snapshot, quick facts, set-off time, and stacked travel items.', category: 'Core User / Main App', recommendedOrder: 1, template: 'home', mockNotes: 'Flagship v1.0 screen with the most complete polish and interaction coverage.' },
  ...
  { id: 18, slug: 'trip-overview-page', name: 'Trip Overview Page', shortDescription: 'Trip hub with transport, stay, weather, and traveller status.', category: 'Core User / Main App', recommendedOrder: 2, template: 'trip-overview' },
