    ...
    documents: [
      {
        ...
        documentNumber: 'MX3L92',
        issueDate: outbound.toISOString(),
        expiryDate: outbound.toISOString(),
        ...
        mimeType: null,
        formalDocumentData: {
          title: 'Outbound boarding pass',
          issuer: 'British Airways',
          referenceCode: 'MX3L92',
          location: 'London Heathrow Terminal 5',
          status: 'Stored',
          summary: '1 cabin bag • Priority boarding',
          railClass: '',
          ticketType: '',
          coach: '',
          seat: '12A',
          travellerName: 'Andrew Moss',
          fare: 'Euro Traveller Plus',
          carrierCode: 'BA',
          flightNumber: 'BA2658',
          departureAirportCode: 'LGW',
          arrivalAirportCode: 'PMI',
          sequence: '44',
          boardingInfo: 'Gate 18 • Boards 07:20',
          gateCloseTime: addHours(outbound, -0.25).toISOString(),
          barcodePayload: 'M1ANDREW/MOSS          EBA2658 LGWPMI',
          barcodeFormat: 'qr',
        },
        sensitive: true,
        createdAt: now,
    ...
    emergencyInfos: [
      {
        ...
        policePhone: '112',
        hospitalContact: 'Son Espases University Hospital, Palma',
        pharmacyContact: 'Farmacia Palma Centro',
